...
> |------|-----------|-------------|
> | `wall-e_xiaozhi/` | ESP-IDF | **Mainline**: single ESP32-S3 voice robot based on xiaozhi-esp32 (wake word + cloud LLM + MCP motion tools + GC9A01 eyes + web control panel + ML307A 4G fallback). See `docs/XIAOZHI_MIGRATION.md` |
